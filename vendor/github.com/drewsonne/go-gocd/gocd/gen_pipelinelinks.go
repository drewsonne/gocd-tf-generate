// Code generated by "gocd-response-links-generator -type=PipelineLinks"; DO NOT EDIT.
package gocd

import "encoding/json"

func (l PipelineLinks) MarshalJSON() ([]byte, error) {
	ls := struct {
...
func (l *PipelineLinks) UnmarshalJSON(j []byte) error {
	var d linkField
